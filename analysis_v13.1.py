...
# Prepare output CSV
csv_filename = "crvq_analysis_results__crvq2.csv"
csv_fields = [
    "lambda", "m", "d", "e",
...
ARCH_FILE = "model_2.py"             # ensure this is present in working directory
CKPT_FILE = "model_2.pth"            # pre-trained weights checkpoint path
