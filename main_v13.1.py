# -*- coding: utf-8 -*-
# LOGLEVEL=INFO python main.py --arch original_model.py --ckpt original_model.pth --out-dir results
"""
...
def load_architecture(py_file: str):
    log.info(f"Loading architecture from {py_file}")
...
def main():
    ...
    # -------- CRVQ quantisation ----------------------------------------- #
    crvq = CRVQ(d=16, e=8, m=3, lam=0.2)
